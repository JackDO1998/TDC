...
tdc.on()
tdc.configure(meas_mode=2,num_stop=5, trig_falling=False, calibration2_periods=10, clock_cntr_stop =39)
...
try:
    while i==0:
        ...
        if status == 1:
            ...
            TOF5=TIME5*normalLSB + COUNT5/CLOCK - (TIME6*normalLSB)
